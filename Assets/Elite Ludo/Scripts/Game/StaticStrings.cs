namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string AndroidPackageName = "com.ludohub.ludogame";
        public static string ITunesAppID = "12345";

        // Notifications
        public static string notificationTitle = "Ludo Hub";
        public static string notificationMessage = "Get your FREE fortune spin!";

        public static string baseURL = "https://ludohub.in/";
        public static  int PawnIndex= 0;
        // Game configuration
        public static float WaitTimeUntilStartWithBots = 20.0f; // Time in seconds. If after that time new player doesnt join room game will start with  s

        public static string privacypolicy = "";
        public static string terms = "";
        public static string contactus = "Jemasmith468@gmail.com";
        // Services configration IDS
        public static string PlayFabTitleID = "5E78C";
        public static string appVersionNumber = "V0001";
        public static string PhotonAppID = "05675e9c-d4b6-416a-b10f-51e7462b54e8";
        public static string PhotonChatID = "d17e53e7-cdab-49f5-935c-1312ae536917";
        ...
        public static string SharePrivateLinkMessage = "Join me in Ludo Hub. My Private Room Code is:";
        public static string SharePrivateLinkMessage2 = "Download Ludo Hub from:";
        public static string ShareApkLink = "https://ludohub.in/";
        public static string ShareScreenShotText = "I finished game in Ludo Hub. It's my score :-) Join me and download Ludo Hub:";

        public static string paymentURl = "https://ludohub.in/";
